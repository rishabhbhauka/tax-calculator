...
function HeroSection() {
  return (
    ...
    >
      ...
      <Link
        href="/calculator"
        className="mt-10 inline-flex items-center gap-2 text-base font-semibold px-8 py-4 transition-transform hover:scale-[1.02] active:scale-[0.98]"
        style={{
      ...
      {/* Trust signals */}
      <div className="mt-10 flex flex-col sm:flex-row gap-4 sm:gap-8 items-center">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {HOW_IT_WORKS_STEPS.map((step) => (
            <div
              key={step.number}
              className="flex flex-col p-6 rounded-[16px]"
              style={{
                background: "var(--color-surface)",
                boxShadow: "var(--shadow-card)",
                border: "1px solid var(--color-border)",
